...
export const publicPocketBaseUrl = import.meta.env.PUBLIC_POCKETBASE_URL || 'http://192.168.3.76:8090';
...
export const fileUrl = (record: any, filename: string) => filename ? `${publicPocketBaseUrl}/api/files/${record.collectionId}/${record.id}/${filename}` : '';
